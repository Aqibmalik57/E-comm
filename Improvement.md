...
3: setting the coupons limit on the cart that allow the coupon use to user according to the products total in the cart not allow user to apply the coupons when the products total goes in negative value after applying coupon on the total
