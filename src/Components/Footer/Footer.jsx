        ...
        <div className="Social-Follow mx-11 me-12 rounded-xl min-h-48 bg-[#f9fafb] grid grid-cols-3 gap-16 ">
          <div className="mb-3 flex justify-center ms-8 flex-col">
            ...
            <div className="flex items-center gap-4">
              <Link to="">
                <TiSocialFacebook className="text-white h-8 w-8 p-[4px] bg-[#3b5998] rounded-3xl" />
              </Link>
              <Link to="">
                <AiOutlineTwitter className="text-white h-8 w-8 p-[5px] rounded-3xl bg-[#00aced]" />
              </Link>
              <Link to="">
                <IoLogoPinterest className="text-white h-8 w-8 p-[5px] rounded-3xl bg-[#cb2128]" />
              </Link>
              <Link to="">
                <BiLogoLinkedin className="text-white h-8 w-8 p-[5px] rounded-3xl bg-[#007fb1]" />
              </Link>
              <Link to="">
                <BiLogoWhatsapp className="text-white h-8 w-8 p-[2px] rounded-3xl bg-[#25d366]" />
              </Link>
            </div>
          </div>
